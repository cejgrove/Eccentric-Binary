...
max_snr0 = max(abs(snr0))
max_index0 = np.argmax(abs(snr0))
max_snr1 = max(abs(snr1))
max_index1 = np.argmax(abs(snr1))
max_snr2 = max(abs(snr2))
max_index2 = np.argmax(abs(snr2))
max_snr3 = max(abs(snr3))
max_index3 = np.argmax(abs(snr3))
...
print str(max_index0)+'   '+str(abs(snr0[0]))+'   '+str(abs(snr0[max_index0]))
print str(max_index1)+'   '+str(abs(snr1[0]))+'   '+str(abs(snr1[max_index1]))
print str(max_index2)+'   '+str(abs(snr2[0]))+'   '+str(abs(snr2[max_index2]))
print str(max_index3)+'   '+str(abs(snr3[0]))+'   '+str(abs(snr3[max_index3]))
